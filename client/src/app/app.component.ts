...
export class AppComponent implements OnInit {
  ...
  setCurrentUser(){
    //As we have stored the object in JSON format in local storage, we are converting back the JSON to object.
    //Adding ! (not) here, as TS is throwing an error that getItem can return null too.
